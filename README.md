...
Global dependencies: `bash coreutils ffmpeg findutils gawk grep kid3-common parallel perl-image-exiftool util-linux`.\
...
`.mp3`|-|Uses [MP3Packer](https://hydrogenaud.io/index.php/topic,32379.0.html), extract+optimize+remux embedded pictures, delete/*keep* ID3v1, use ID3v2.4 UTF-8, *remove* metadata padding, remove/*keep* metadata.|N/A
